!(function () {
  ...
  function $(e) {
    ...
    A ||
      (function () {
        var e = f('div');
        e.classList.add('progress'), k(v, e), (A = e);
      })(),
      (t = i
        ? 80 < (t = parseInt(A.style.width || 0, 10) + i)
          ? 80
          : t
        : Math.floor((n / r) * 100)),
      (A.style.opacity = 1),
      (A.style.width = 95 <= t ? '100%' : t + '%'),
      95 <= t &&
        (clearTimeout(C),
        (C = setTimeout(function (e) {
          (A.style.opacity = 0), (A.style.width = '0%');
        }, 200)));
  }
  var E = {};
  function F(a, e, t) {
  ...
  function P(e, t, r, n) {
    ...
    return (
      ...
      n && (u.title = a ? a.title || a.innerText + ' - ' + R : R),
      a
    );
  }
  ...
  var J = Q(function (e, t) {
      ...
      (n = X),
        (e.exports = (function (e) {
          ...
          return e.CSS || (e.CSS = {}), (e.CSS.escape = t);
        })(n));
    }),
    K = {},
    ee = !1,
    ...
    if (ne) {
      for (
        var t,
          ...
          o = ((s && s.scrollTop) || document.body.scrollTop) - re,
          l = 0,
          c = r.length;
        l < c;
        l += 1
      ...
      if (t) {
        var h = K[ae(decodeURIComponent(e), t.getAttribute('data-id'))];
        if (
          h &&
          h !== a &&
          ...
          (a = h),
          !ee && v.classList.contains('sticky'))
        ) {
  ...
  function se(e, t) {
    if (t) {
      ...
      var r = K[ae(e, t)],
        i = b(m('.sidebar'), 'li.active');
      i && i.classList.remove('active'), r && r.classList.add('active');
    }
  }
  var oe = u.scrollingElement || u.documentElement;
  function le(e, t) {
    if (
  ...
  function ge(e) {
    ...
    var t = e
        ...
        .replace(/-+/g, '-'),
      n = he[t];
    return (n = l.call(he, t) ? n + 1 : 0), (he[t] = n) && (t = t + '-' + n), t;
  }
  function fe(e, t) {
    return (
        ...
        var u = /\blang(?:uage)?-([\w-]+)\b/i,
          ...
          T = {
            ...
            highlightAllUnder: function (e, t, n) {
              ...
              for (
                var i, a = e.querySelectorAll(r.selector), s = 0;
                (i = a[s++]);
            ...
            highlightElement: function (e, t, n) {
              for (var r, i = 'none', a = e; a && !u.test(a.className); )
                a = a.parentNode;
              a &&
                ((i = (a.className.match(u) || [, 'none'])[1].toLowerCase()),
                (r = T.languages[i])),
                (e.className =
              ...
              if ((T.hooks.run('before-sanity-check', o), o.code))
                      ...
                      if (!(y instanceof R)) {
                        ...
                        if (A) {
                          ...
                          if (
                            ...
                            1 != C && T.matchGrammar(e, t, n, v, b, !0, o),
                            a)
                          )
                            break;
                        } else if (a) break;
        ...
        'undefined' != typeof self &&
          ...
          ((self.Prism.fileHighlight = function (e) {
            ...
            Array.prototype.slice
              ...
              c.plugins.toolbar &&
                c.plugins.toolbar.registerButton('download-file', function (e) {
  ...
  (me = Prism),
    Object.defineProperties((me.languages['markup-templating'] = {}), {
      buildPlaceholders: {
        value: function (r, i, e, a) {
          if (r.language === i) {
            ...
            (r.code = r.code.replace(e, function (e) {
              ...
              for (var t, n = s.length; -1 !== r.code.indexOf((t = be(i, n))); )
                ++n;
              return (s[n] = e), t;
            })),
              (r.grammar = me.languages.markup);
          }
        },
      },
      ...
      !(function () {
        ...
        function m(e, n, r) {
          ...
          if (r || 'function' == typeof n) {
            ...
            try {
              return (
                f((n = n && d({}, m.defaults, n))), c.parse(l.lex(e, n), n)
              );
            } catch (e) {
              if (
                ((e.message +=
  ...
  var xe = {
    ...
    _e = function (i, e) {
      ...
      (s = r(n)
        ? n(ye, t)
        : (ye.setOptions(d(n, { renderer: d(t, n.renderer) })), ye)),
        (this._marked = s),
                  ...
                  (t = i.noEmoji
                    ...
                    : (function (e) {
                        return e
                          ...
                          .replace(/:(\w+?):/gi, window.emojify || fe)
                          .replace(/__colon__/g, ':');
                      })(t)),
                  ge.clear(),
                  t)
  ...
  (_e.prototype.compileEmbed = function (e, t) {
    ...
    if (((t = i), a.include)) {
      var s;
      if (
        (q(e) || (e = Z(this.contentBase, H(this.router.getCurrentPath()), e)),
        a.type && (s = xe[a.type]))
      )
    ...
    (_e.prototype._matchNotCompileLink = function (e) {
      for (var t = this.config.noCompileLinks || [], n = 0; n < t.length; n++) {
        var r = t[n];
        if ((ke[r] || (ke[r] = new RegExp('^' + r + '$'))).test(e)) return e;
      }
    }),
    (_e.prototype._initRenderer = function () {
      var e = new ye.Renderer(),
        t = this.linkTarget,
        l = this.router,
        n = this.contentBase,
        c = this,
      ...
      return (
        ...
        (r.code = (function (e) {
          return (e.renderer.code = function (e, t) {
            void 0 === t && (t = '');
            var n = ve.languages[t] || ve.languages.markup;
            return (
              '<pre v-pre data-lang="' +
              t +
              '"><code class="lang-' +
              t +
              '">' +
              ve.highlight(e.replace(/@DOCSIFY_QM@/g, '`'), n) +
              '</code></pre>'
            );
          });
        })({ renderer: e })),
        (r.link = (function (e) {
          ...
          return (t.link = function (e, t, n) {
            ...
            return (
              (t = a),
              q(e) || c._matchNotCompileLink(e) || s.ignore
        ...
        (r.image = (function (e) {
          ...
          return (t.image = function (e, t, n) {
            ...
            return (
              ...
              o.id && i.push('id="' + o.id + '"'),
              q(e) || (r = Z(h, H(p.getCurrentPath()), e)),
              '<img src="' +
                r +
                '" data-origin="' +
                e +
    ...
    (_e.prototype.sidebar = function (e, t) {
      ...
      if (e) i = this.compile(e);
        ...
        var l = this.cacheTree[r] || ue(n, t);
        (i = le(l, '<ul>{inner}</ul>')), (this.cacheTree[r] = l);
      }
      return i;
    }),
      ...
      for (; (t = n[o++]); ) {
        var r = (function (i) {
          return function (e) {
            var t;
            if (e)
              if ('markdown' === i.embed.type) t = s.lexer(e);
                    ...
                    a.push(
                      (i && i[t]) ||
                        function (e) {
                          return (
                            '00' +
                            ('string' == typeof Ee[t] ? e[Ee[t]]() : Ee[t](e))
                          ).slice(-t.length);
                        },
                    );
                }),
    ...
    if (i) {
      if (
        ...
        var o = /^data:image/.test(t.logo),
          ...
          c = /^\./.test(t.logo);
        o || l || c || (t.logo = Z(e.router.getBasePath(), t.logo));
      }
      (a += (function (e) {
        var t = e.name ? e.name : '',
          n =
        ...
        (function (n) {
          if (
            ...
            [].forEach.call(e, function (e) {
              if ('STYLE' === e.nodeName) L(e, n);
              else if ('LINK' === e.nodeName) {
                var t = e.getAttribute('href');
                if (!/\.css$/.test(t)) return;
                F(t).then(function (e) {
                  var t = f('style', e);
                  p.appendChild(t), L(t, n);
                });
              }
            });
          }
  ...
  (Pe.prototype.getBasePath = function () {
    ...
    (Pe.prototype.toURL = function (e, t, n) {
      ...
      if (
        ((i.query = d({}, i.query, t)),
        (e = (e = i.path + M(i.query)).replace(/\.md(\?)|\.md$/, '$1')),
        r)
      ) {
        var a = n.indexOf('?');
  ...
  var Ne = (function (r) {
      ...
      return (
        ...
        (e.prototype.onchange = function (e) {
          void 0 === e && (e = h), x('hashchange', e);
        }),
        (e.prototype.normalize = function () {
          var e = this.getCurrentPath();
          if ('/' === (e = D(e)).charAt(0)) return ze(e);
          ze('/' + e);
        }),
        (e.prototype.parse = function (e) {
          ...
          return (
            ...
            { path: e, file: this.getFile(e, !0), query: j(t) }
          );
        }),
    ...
    je = (function (t) {
      ...
      return (
        ...
        (e.prototype.parse = function (e) {
          ...
          var r = Z(location.origin),
            i = e.indexOf(r);
          return (
            -1 < i && (e = e.slice(i + r.length)),
            { path: e, file: this.getFile(e), query: j(t) }
          );
        }),
        e
      );
        ...
        null != (e = m(e)) &&
          x(e, 'click', function (e) {
            ...
            'A' === t.nodeName &&
              ...
              S(t.parentNode, 'collapse');
          });
      })('.sidebar', e.router),
      e.config.coverpage ? g || x('scroll', O) : v.classList.add('sticky');
  }
  ...
  var De,
    ...
    Ge = Ze.prototype;
  function Ve(e, t, n) {
    return Ye && Ye.abort && Ye.abort(), (Ye = F(e, !0, n));
  }
  (Ge._init = function () {
    var e = this;
    (e.config = (function () {
      ...
      (function (t) {
        var e,
          n = t.config;
        (e =
          'history' === (n.routerMode || 'hash') && s ? new je(n) : new Ne(n)),
          (t.router = e),
          qe(t),
          (Me = t.route),
      ...
      (function (t) {
        ...
        if (t.rendered) {
          var n = P(t.router, '.sidebar-nav', !0, !0);
    ...
    (Ge.route = {}),
    ((De = Ge)._renderTo = function (e, t, n) {
      var r = m(e);
    ...
    (De._renderSidebar = function (e) {
      ...
      var a = P(this.router, '.sidebar-nav', !0, !0);
      i && a
    ...
    (De._bindEventOnRendered = function (e) {
      ...
      if (
        ...
        a &&
          'H1' !== a.tagName &&
          w(i, f('div', this.compiler.header(e.innerText, 1)).children[0]);
      }
      r &&
        (function (e) {
          void 0 === e && (e = 0), (oe.scrollTop = !0 === e ? 0 : Number(e));
        })(r);
    }),
    (De._renderNav = function (e) {
      e && this._renderTo('nav', this.compiler.compile(e)),
        this.config.loadNavbar && P(this.router, 'nav');
    }),
    (De._renderMain = function (r, i, a) {
      var s = this;
      if ((void 0 === i && (i = {}), !r)) return Te.call(this, r);
      T(this, 'beforeEach', r, function (e) {
        function t() {
          i.updatedAt && (n = Le(n, i.updatedAt, s.config.formatUpdated)),
            T(s, 'afterEach', n, function (e) {
              return Te.call(s, e);
            });
        }
        var n;
        s.isHTML
          ? ((n = s.result = r), t(), a())
          : Ce({ compiler: s.compiler, raw: e }, function (e) {
    ...
    (De._renderCover = function (e, t) {
      var n = m('.cover');
      if ((S(m('main'), t ? 'add' : 'remove', 'hidden'), e)) {
        S(n, 'add', 'show');
        ...
        if (i) {
          if ('color' === i[2]) n.style.background = i[1] + (i[3] || '');
            ...
            var a = i[1];
            S(n, 'add', 'has-mask'),
              q(i[1]) || (a = Z(this.router.getBasePath(), i[1])),
        ...
        this._renderTo('.cover-main', r), O();
      } else S(n, 'remove', 'show');
    }),
    ...
    ((Ue = Ge)._loadSideAndNav = function (e, t, n, r) {
      var i = this;
      return function () {
        if (!n) return r();
        Ie(
        ...
        return (
          s
            ? ((s = this.router.getFile(a + s)),
              ...
              F(s + M(i, ['id']), !1, r).then(function (e) {
    ...
    (Ue._fetch404 = function (e, t, n) {
      ...
      if (o) {
        ...
        return (
          Ve(this.router.getFile(c), 0, s).then(
            function (e, t) {
    ...
    (Ge.$resetEvents = function () {
      se(this.route.path, this.route.query.id),
        this.config.loadNavbar && P(this.router, 'nav');
    }),
    (window.Docsify = {
      util: Be,
