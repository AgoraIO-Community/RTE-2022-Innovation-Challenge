...
public class ConstantApp {
    ...
    public static final int PERMISSION_REQ_ID_LOCATION = BASE_VALUE_PERMISSION + 3;
    public static final int PERMISSION_REQ_ID_FINE_LOCATION = BASE_VALUE_PERMISSION + 4;
