...
public class CallActivity extends BaseActivity implements DuringCallEventHandler {
    ...
    public void onPreviewResult(byte[] data) {
        ...
        mSource.getConsumer().consumeByteArrayFrame(data, AgoraVideoFrame.FORMAT_NV21, AGApplication.camWidth, AGApplication.camHeight, 90, System.currentTimeMillis());
    }
/*
 ...
 */
    ...
    protected void initUIandEvent() {
        ...
        LinearLayout lin= findViewById(R.id.camera_view1);
        application().SetUVCView(lin,true);
        //surfaceV.setCallback(this);
        preview(true, null, 0);
    ...
    public void onHangupClicked(View view) {
       ...
       // LinearLayout lin= findViewById(R.id.camera_view1);
      //  application().SetUVCView(lin,false);
        finish();
    }
    ...
    public void onVideoMuteClicked(View view) {
      ...
      /*  if (mUidsList.size() == 0) {
       ...
       /* if (mVideoMuted) {
        ...
        rtcEngine.enableLocalVideo(!mVideoMuted);
