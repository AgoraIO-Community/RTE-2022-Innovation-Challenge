...
*/
   ...
   //     AddDeviceOther("门口监控", DeviceStatus.ONLINE, VideoType.VideoFile, @"C:\Users\Petit\Desktop\腹肌撕裂者X.mp4");
     //   AddDeviceOther("门口监控", DeviceStatus.ONLINE, VideoType.VideoFile, "http://ivi.bupt.edu.cn/hls/cctv1hd.m3u8");
        
    }

    private void AddDeviceOther(string v1, DeviceStatus oNLINE, VideoType videoFile, string v2)
    {
    ...
    void Update()
    {
        for(int i=0;i< allDevices.Count; i++)
        {
            ...
            {
                allDevices.Remove(allDevices[i]);
                break;
            }
