  ...
  <div>
    ...
    <DropZone v-slot="{ dropZoneActive }" class="drop-area" @files-dropped="addFilesAndStartUpload">
      <div v-if="modelValue" class="relative">
        ...
        <ipfs-img class="rounded-lg object-cover h-60 w-full" :src="modelValue" :alt="title" />
      </div>
      <div v-else class="border-dashed rounded-md flex border-2 border-gray-300mt-1 px-6 pt-5 pb-6 justify-center relative overflow-hidden">
