...
class EasemobService extends Service {
  ...
  */
  /**
   * 获取用户信息
   * @param username 注册到环信的用户 id，对应环信的 username
   */
  async getUser(username) {
    ...
    const apiUrl = `${app.config.easemob.host}/${app.config.easemob.orgName}/${app.config.easemob.appName}/users/${username}`;
