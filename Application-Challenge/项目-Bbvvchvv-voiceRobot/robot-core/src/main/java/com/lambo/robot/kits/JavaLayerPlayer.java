 ...
 */
public class JavaLayerPlayer implements AutoCloseable {
    /**
     ...
     */
    public JavaLayerPlayer(InputStream stream) throws JavaLayerException {
        this(stream, null);
    }

    public JavaLayerPlayer(InputStream stream, AudioDevice device) throws JavaLayerException {
