...
public class PushAndMessageHelper {
    ...
    public static void sendForwardMessage(String toChatUsername, String msgId) {
        ...
        EMMessage message = com.qingkouwei.handyinstruction.DemoHelper.getInstance().getChatManager().getMessage(msgId);
     ...
     * @param identityCode
     */
    private static void sendBigExpressionMessage(
        String toChatUsername, String name, String identityCode){
