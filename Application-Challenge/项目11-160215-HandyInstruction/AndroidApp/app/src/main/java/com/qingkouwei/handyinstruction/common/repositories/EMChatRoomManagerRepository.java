...
public class EMChatRoomManagerRepository extends BaseEMRepository{
                ...
                EaseThreadManager.getInstance().runOnIOThread(()-> {
                    ...
                    try {
                        ...
                        if(isAdmin(chatRoom)) {
                            ...
                            List<String>
                                blacks = getChatRoomManager().fetchChatRoomBlackList(roomId, 0, 500);
     ...
     * @return
     */
    public LiveData<Resource<EMChatRoom>> changeChatroomDescription(
        String roomId, String newDescription) {
        return new NetworkOnlyResource<EMChatRoom>() {
            @Override
            protected void createCall(@NonNull ResultCallBack<LiveData<EMChatRoom>> callBack) {
     ...
     * @return
     */
    public LiveData<Resource<EMChatRoom>> removeUserFromChatRoom(
        String groupId, List<String> usernames) {
        return new NetworkOnlyResource<EMChatRoom>() {
            @Override
            protected void createCall(@NonNull ResultCallBack<LiveData<EMChatRoom>> callBack) {
     ...
     * @return
     */
    public LiveData<Resource<EMChatRoom>> unMuteChatRoomMembers(
        String groupId, List<String> usernames) {
        return new NetworkOnlyResource<EMChatRoom>() {
            @Override
            protected void createCall(@NonNull ResultCallBack<LiveData<EMChatRoom>> callBack) {
     ...
     * @return
     */
    public LiveData<Resource<EMChatRoom>> createChatRoom(
        String subject, String description, String welcomeMessage,
