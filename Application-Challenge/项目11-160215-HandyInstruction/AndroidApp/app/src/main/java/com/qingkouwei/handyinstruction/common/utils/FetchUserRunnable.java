package com.qingkouwei.handyinstruction.common.utils;
...
public class FetchUserRunnable implements Runnable {
    ...
    private void warpEMUserInfo(Map<String, EMUserInfo> userInfos){
        ...
        Map<String, EaseUser> exitUsers = com.qingkouwei.handyinstruction.DemoHelper.getInstance().getContactList();
        ...
        //更新本地数据库信息
        com.qingkouwei.handyinstruction.DemoHelper.getInstance().updateUserList(userEntities);
