...
import com.qingkouwei.handyinstruction.common.enums.Status;
import com.qingkouwei.handyinstruction.common.interfaceOrImplement.OnResourceParseCallback;
import com.qingkouwei.handyinstruction.common.interfaceOrImplement.UserActivityLifecycleCallbacks;
...
import com.qingkouwei.handyinstruction.common.widget.EaseProgressDialog;
    ...
    protected void registerAccountObservable() {
        LiveDataBus.get().with(DemoConstant.ACCOUNT_CHANGE, EaseEvent.class).observe(this, event -> {
            ...
            if(TextUtils.equals(accountEvent, DemoConstant.ACCOUNT_REMOVED) ||
                ...
                com.qingkouwei.handyinstruction.DemoHelper.getInstance().logout(false, new EMCallBack() {
                    @Override
                ...
                com.qingkouwei.handyinstruction.DemoHelper.getInstance().logout(false, null);
