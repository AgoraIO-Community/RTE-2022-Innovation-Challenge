package com.qingkouwei.handyinstruction.section.chat.views;
...
public class ChatRowRecall extends EaseChatRow {
    ...
    protected void onSetUpView() {
        ...
        if (message.direct() == EMMessage.Direct.SEND&&(TextUtils.isEmpty(recaller)||((!TextUtils.isEmpty(recaller))&& TextUtils
            .equals(recaller, from)))) {
