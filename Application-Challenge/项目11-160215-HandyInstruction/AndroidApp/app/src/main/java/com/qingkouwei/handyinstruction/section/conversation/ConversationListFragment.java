package com.qingkouwei.handyinstruction.section.conversation;
...
import com.qingkouwei.handyinstruction.section.search.SearchConversationActivity;
...
public class ConversationListFragment extends EaseConversationListFragment implements View.OnClickListener {
    ...
    public void initData() {
        ...
        if(com.qingkouwei.handyinstruction.DemoHelper.getInstance().isFirstInstall() && EMClient.getInstance().chatManager().getAllConversations().isEmpty()) {
