package com.qingkouwei.handyinstruction.section.conversation.adapter;
...
public class HomeAdapter extends EaseBaseRecyclerViewAdapter<Object> {
    ...
    public ViewHolder getViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(
            LayoutInflater.from(mContext).inflate(R.layout.demo_item_row_chat_history, parent, false));
    }
        ...
        public void setData(Object object, int position) {
            if(object instanceof EMConversation) {
                ...
                if(mentioned.getVisibility() != View.VISIBLE) {
                    String unSendMsg = com.qingkouwei.handyinstruction.DemoHelper.getInstance().getModel().getUnSendMsg(username);
