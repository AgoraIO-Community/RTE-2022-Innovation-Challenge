...
import com.qingkouwei.handyinstruction.section.base.BaseDialogFragment;
    ...
    public void initData() {
        ...
        if(!TextUtils.isEmpty(preStartTime) && !TextUtils.isEmpty(preEndTime)) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                pickerStart.setMinute(
                    Integer.parseInt(preStartTime.substring(preStartTime.indexOf(":") + 1)));
                ...
                pickerStart.setCurrentMinute(
                    Integer.parseInt(preStartTime.substring(preStartTime.indexOf(":") + 1)));

                pickerEnd.setCurrentHour(Integer.parseInt(preEndTime.substring(0, preEndTime.indexOf(":"))));
                pickerEnd.setCurrentMinute(
                    Integer.parseInt(preEndTime.substring(preEndTime.indexOf(":") + 1)));
            }
        }
