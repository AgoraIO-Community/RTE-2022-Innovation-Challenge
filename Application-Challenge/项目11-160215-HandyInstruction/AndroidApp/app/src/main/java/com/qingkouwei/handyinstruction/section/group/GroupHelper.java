...
public class GroupHelper {
    ...
    public static boolean isOwner(EMGroup group) {
        ...
        return TextUtils.equals(group.getOwner(), com.qingkouwei.handyinstruction.DemoHelper.getInstance().getCurrentUser());
    }
    ...
    public static boolean isOwner(EMChatRoom room) {
        ...
        return TextUtils.equals(room.getOwner(), com.qingkouwei.handyinstruction.DemoHelper.getInstance().getCurrentUser());
    }
    ...
    public synchronized static boolean isAdmin(EMGroup group) {
        ...
        if(adminList != null && !adminList.isEmpty()) {
            return adminList.contains(com.qingkouwei.handyinstruction.DemoHelper.getInstance().getCurrentUser());
        }
        return false;
    }
