...
import com.qingkouwei.handyinstruction.section.group.viewmodels.ChatRoomDetailViewModel;
...
public class ChatRoomDetailActivity extends BaseInitActivity implements EaseTitleBar.OnBackPressListener, View.OnClickListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        chatRoom = com.qingkouwei.handyinstruction.DemoHelper.getInstance().getChatroomManager().getChatRoom(roomId);
    ...
    private boolean isOwner() {
        return chatRoom != null && TextUtils.equals(com.qingkouwei.handyinstruction.DemoHelper.getInstance().getCurrentUser(), chatRoom.getOwner());
    }
}
