...
import com.qingkouwei.handyinstruction.section.group.viewmodels.ChatRoomMemberViewModel;
...
public class ChatRoomMemberAuthorityActivity extends GroupMemberAuthorityActivity {
    ...
    protected void onSubPrepareOptionsMenu(Menu menu) {
        ...
        if(!isOwner() && !isInAdminList(com.qingkouwei.handyinstruction.DemoHelper.getInstance().getCurrentUser())) {
                ...
                public void onSuccess(List<String> data) {
                    ...
                    if(data != null && !data.isEmpty()){
                        for(int i = 0; i < data.size(); i++){
                            EaseUser user = com.qingkouwei.handyinstruction.DemoHelper.getInstance().getUserInfo(data.get(i));
                            if(user != null){
                                users.add(user);
                            }else{
    ...
    public boolean isMember() {
        String currentUser = com.qingkouwei.handyinstruction.DemoHelper.getInstance().getCurrentUser();
