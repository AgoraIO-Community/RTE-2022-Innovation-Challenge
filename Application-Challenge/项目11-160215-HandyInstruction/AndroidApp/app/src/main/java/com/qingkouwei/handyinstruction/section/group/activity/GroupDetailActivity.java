package com.qingkouwei.handyinstruction.section.group.activity;
...
import com.qingkouwei.handyinstruction.section.dialog.EditTextDialogFragment;
...
import com.qingkouwei.handyinstruction.section.group.fragment.GroupEditFragment;
import com.qingkouwei.handyinstruction.section.group.viewmodels.GroupDetailViewModel;
import com.qingkouwei.handyinstruction.section.search.SearchGroupChatActivity;
...
public class GroupDetailActivity extends BaseInitActivity implements EaseTitleBar.OnBackPressListener, View.OnClickListener, SwitchItemView.OnCheckedChangeListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        group = com.qingkouwei.handyinstruction.DemoHelper.getInstance().getGroupManager().getGroup(groupId);
        initGroupView();
    }
    ...
    private void initGroupView() {
        ...
        conversation = com.qingkouwei.handyinstruction.DemoHelper.getInstance().getConversation(groupId, EMConversation.EMConversationType.GroupChat, true);
        ...
        List<String> disabledIds = com.qingkouwei.handyinstruction.DemoHelper.getInstance().getPushManager().getNoPushGroups();
