...
public class GroupManageIndexActivity extends BaseInitActivity implements View.OnClickListener, EaseTitleBar.OnBackPressListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        btnTransfer.setVisibility(GroupHelper.isOwner(
            com.qingkouwei.handyinstruction.DemoHelper.getInstance().getGroupManager().getGroup(groupId)) ? View.VISIBLE : View.GONE);
    }
