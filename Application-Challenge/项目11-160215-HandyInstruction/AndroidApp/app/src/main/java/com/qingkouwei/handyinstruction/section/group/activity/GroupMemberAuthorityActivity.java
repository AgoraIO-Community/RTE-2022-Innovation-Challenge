...
import com.qingkouwei.handyinstruction.section.group.adapter.GroupMemberAuthorityAdapter;
import com.qingkouwei.handyinstruction.section.group.viewmodels.GroupMemberAuthorityViewModel;
...
public class GroupMemberAuthorityActivity extends BaseInitActivity implements EaseTitleBar.OnBackPressListener, OnItemClickListener, OnRefreshListener, OnItemLongClickListener {
    ...
    public boolean onItemLongClick(View view, int position) {
        ...
        MenuPopupHelper
            menuPopupHelper = new MenuPopupHelper(mContext, (MenuBuilder) menu.getMenu(), view);
