...
public class GroupSimpleDetailActivity extends BaseInitActivity implements View.OnClickListener, EaseTitleBar.OnBackPressListener {
    ...
    private void addToGroup() {
        ...
        if(TextUtils.isEmpty(reason)) {
            reason = getString(R.string.demo_group_listener_onRequestToJoinReceived, com.qingkouwei.handyinstruction.DemoHelper
                .getInstance().getCurrentUser(), group.getGroupName());
        }
