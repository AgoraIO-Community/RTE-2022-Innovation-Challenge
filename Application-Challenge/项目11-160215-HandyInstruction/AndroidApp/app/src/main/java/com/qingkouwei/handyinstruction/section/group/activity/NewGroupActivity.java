...
import com.qingkouwei.handyinstruction.section.contact.viewmodels.NewGroupViewModel;
...
public class NewGroupActivity extends BaseInitActivity implements EaseTitleBar.OnBackPressListener, EaseTitleBar.OnRightClickListener, View.OnClickListener, SwitchItemView.OnCheckedChangeListener {
    ...
    private void checkGroupInfo() {
        ...
        String
            reason = getString(R.string.em_group_new_invite_join_group, com.qingkouwei.handyinstruction.DemoHelper
            .getInstance().getCurrentUser(), groupName);
