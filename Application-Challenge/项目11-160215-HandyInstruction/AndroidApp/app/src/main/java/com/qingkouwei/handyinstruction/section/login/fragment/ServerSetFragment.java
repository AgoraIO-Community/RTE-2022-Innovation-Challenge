...
import com.qingkouwei.handyinstruction.common.model.DemoServerSetBean;
...
public class ServerSetFragment extends BaseInitFragment implements EaseTitleBar.OnBackPressListener, CompoundButton.OnCheckedChangeListener,
    ...
    private void checkServerSet() {
        ...
        mEtAppkey.setText((!DemoHelper.getInstance().getModel().isCustomAppkeyEnabled() || TextUtils
            .isEmpty(appkey)) ? "":appkey);
