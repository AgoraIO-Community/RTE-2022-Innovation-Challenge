...
import com.qingkouwei.handyinstruction.section.me.headImage.HeadImageAdapter;
import com.qingkouwei.handyinstruction.section.me.headImage.HeadImageInfo;
            ...
            if(selectHeadUrl != null){
                EMClient.getInstance().userInfoManager().updateOwnInfoByAttribute(EMUserInfoType.AVATAR_URL, selectHeadUrl, new EMValueCallBack<String>() {
                    ...
                    public void onSuccess(String value) {
                        ...
                        com.qingkouwei.handyinstruction.DemoHelper.getInstance().getUserProfileManager().updateUserAvatar(selectHeadUrl);
    ...
    private void getHeadImageSrc(String srcUrl){
        new AsyncTask<String, Void, Pair<Integer, String>>(){
            ...
            protected Pair<Integer, String> doInBackground(String... str) {
                try {
                    Pair<Integer, String>
                        response = EMHttpClient.getInstance().sendRequestWithToken(srcUrl, null,EMHttpClient.GET);
                    return response;
