...
public class FeedbackActivity extends BaseInitActivity implements View.OnClickListener, EaseTitleBar.OnRightClickListener, EaseTitleBar.OnBackPressListener {
    ...
    private static final String[] questions = {
        com.qingkouwei.handyinstruction.DemoApplication.getInstance().getApplicationContext().getString(R.string.em_feedback_question_bug), com.qingkouwei.handyinstruction.DemoApplication
        .getInstance().getApplicationContext().getString(R.string.optimization_suggestions), com.qingkouwei.handyinstruction.DemoApplication
        .getInstance().getApplicationContext().getString(R.string.other)};
