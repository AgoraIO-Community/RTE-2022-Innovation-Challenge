package com.qingkouwei.handyinstruction.section.me.headImage;
...
public class HeadImageAdapter extends EaseBaseRecyclerViewAdapter<HeadImageInfo> {
    ...
    public ViewHolder getViewHolder(ViewGroup parent, int viewType) {
        return new HeadImageViewHolder(
            LayoutInflater.from(mContext).inflate(R.layout.content_head_image_item, parent, false));
    }
