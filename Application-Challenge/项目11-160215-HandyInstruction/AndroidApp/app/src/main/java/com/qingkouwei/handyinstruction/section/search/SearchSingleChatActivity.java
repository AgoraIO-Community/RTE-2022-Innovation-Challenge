...
import com.qingkouwei.handyinstruction.section.chat.activity.ChatHistoryActivity;
import com.qingkouwei.handyinstruction.section.search.adapter.SearchMessageAdapter;
...
public class SearchSingleChatActivity extends SearchActivity {
    ...
    public void searchMessages(String search) {
        List<EMMessage>
            mData = conversation.searchMsgFromDB(search, System.currentTimeMillis(), 100, null, EMConversation.EMSearchDirection.UP);
