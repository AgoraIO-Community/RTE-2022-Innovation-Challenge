package com.qingkouwei.handyinstruction.section.search.adapter;
...
public class SearchMessageAdapter extends EaseBaseRecyclerViewAdapter<EMMessage> {
    ...
    public ViewHolder getViewHolder(ViewGroup parent, int viewType) {
        View
            view = LayoutInflater.from(mContext).inflate(R.layout.demo_item_row_chat_history, parent, false);
        ...
        public void setData(EMMessage item, int position) {
            ...
            message.post(()-> {
                ...
                SpannableStringBuilder
                    builder = EaseEditTextUtils.highLightKeyword(mContext, subContent, keyword);
                if(builder != null) {
