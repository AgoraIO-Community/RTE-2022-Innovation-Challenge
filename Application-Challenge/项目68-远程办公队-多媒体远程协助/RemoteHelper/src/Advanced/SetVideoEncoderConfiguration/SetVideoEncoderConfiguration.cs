...
namespace RTRemoteHelper
{
    public class SetVideoEncoderConfiguration : IEngine
    {
        ...
        internal override int Init(string appId, string channelId)
        {
            ...
            //RemoteHelperForm.dump_handler_(SetVideoEncoderConfiguration_TAG + "SetLogFile", ret);
        ...
        internal override int JoinChannel()
        {
            ...
            if (null != rtc_engine_)
            {
                ...
                RemoteHelperForm.dump_handler_(SetVideoEncoderConfiguration_TAG + "SetLocalAccessPoint", ret);*/
            }
            return ret;
        }
