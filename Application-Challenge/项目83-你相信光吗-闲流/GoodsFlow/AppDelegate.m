...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    EMOptions *options = [EMOptions optionsWithAppkey:@"1116220809115488#demo"];
...
- (void)loginStateChange:(NSNotification *)aNotif
{
    ...
    if (loginSuccess) {//登录成功加载主窗口控制器
        ...
        if (!navigationController || (navigationController && ![navigationController.viewControllers[0] isKindOfClass:[DCTabViewController class]])) {
            DCTabViewController *homeController = [DCTabViewController sharedMainTabBarController];
        ...
        config.agoraAppId = @"7fd2a90320cc4558b620215916a23ccb";
