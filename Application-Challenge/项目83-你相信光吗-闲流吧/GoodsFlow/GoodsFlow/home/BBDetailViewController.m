...
- (void)initSubviews{
    ...
    NSString * name = [NSString stringWithFormat:@"交易物品:  %@",self.model.pName];
...
//    [self textHeight:self.model.pName];
    ...
    categoryLB.width = KScreenWidth - 90;
    categoryLB.x = lbx;
    categoryLB.y = 60;
    categoryLB.height = 25;
    NSString * category = [NSString stringWithFormat:@"取货方式:  %@",self.model.pcategory];
    categoryLB.text = category;
    categoryLB.numberOfLines = 0;
    categoryLB.textColor = UIColor.blackColor;
    [backGreenView addSubview:categoryLB];
    ...
    NSString * city = [NSString stringWithFormat:@"所在位置:  %@",self.model.address];
...
- (void)share{
    ...
    [imgArr insertObject:@"闲流" atIndex:0];
