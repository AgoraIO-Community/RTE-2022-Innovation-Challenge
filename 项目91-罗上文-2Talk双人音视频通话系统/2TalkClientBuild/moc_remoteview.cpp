...
QT_MOC_LITERAL(1, 11, 12), // "quit_channel"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "RemoteView\0quit_channel\0"
};
...
void RemoteView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RemoteView::quit_channel)) {
                *result = 0;
                return;
            }
        }
